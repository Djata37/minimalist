    ...
    async function handleSubmit(event) {
      ...
      const valideText = document.getElementById("valide");
      ...
      fetch(event.target.action, {
        ...
        valideText.textContent = "Merci, votre message à bien était transmis.";
        form.reset()
      }).catch(error => {
        valideText.textContent = "Veuillez corriger vos erreurs."
      });
    }
